		...
		<section className='bg-black pt-28 pb-24 md:px-3 px-5 md:snap-center snap-start'>
			<div className='max-w-[1200px] mx-auto flex flex-col  gap-y-3'>
				...
				<div className='flex md:flex-row flex-col md:gap-5 gap-4  justify-center'>
					<div className='flex flex-col gap-4 '>
						...
						<div className=' relative w-full overflow-hidden'>
							<input
								type='checkbox'
								className='absolute top-0 inset-x-0 w-full h-14 opacity-0 z-10  cursor-pointer peer'
							/>
							<div className=' h-14 px-10 flex flex-col justify-center rounded-lg transition-all duration-500 text-black bg-white peer-checked:bg-[#0071FF] peer-checked:text-white'>
								<h2 className='font-bowl'>Is WhatsApp Business API free?</h2>
							</div>
							...
							<div className='overflow-hidden bg-black  transition-all duration-500 max-h-0 peer-checked:max-h-60'>
								<div className='p-5'>
									<p className='lg:px-10 px-5'>
										No, WhatsApp Business API isn't Free. Only Procurement of
										WhatsApp Business API is free. But, you'd need to pay
										WhatsApp Conversation charges for Business & User Initiated
										Conversations
									</p>
								</div>
							</div>
						...
						<div className=' relative overflow-hidden '>
							...
							/>
							<div className=' h-14 px-10 flex flex-col justify-center rounded-lg transition-all duration-500 text-black bg-white peer-checked:bg-[#0071FF] peer-checked:text-white'>
								<h2 className='font-bowl'>What is WhatsApp Conversation?</h2>
							</div>
							<div className='absolute text-[#0077FF] top-4 right-4 transition-transform duration-500 rotate-0 peer-checked:rotate-90 peer-checked:text-white'>
								<svg
									xmlns='http://www.w3.org/2000/svg'
							...
							<div className='overflow-hidden bg-black  transition-all duration-500 max-h-0 peer-checked:max-h-60'>
								<div className='p-5'>
									<p className='lg:px-10 px-5'>
										WhatsApp Conversation is a 24-hour messaging window
										initiated only when a business messages a user. Businesses
										and users can exchange any number of messages, including
										template messages, within a 24 hour conversation session
						...
						<div className=' relative w-full overflow-hidden '>
							...
							<div className='overflow-hidden bg-black  transition-all duration-500 max-h-0 peer-checked:max-h-60'>
								<div className='p-5'>
									<p className='lg:px-10 px-5'>
										Whenever a business replies to a user within the 24 hour
										customer service window, that message initiates a
						...
						<div className=' relative w-full overflow-hidden '>
							...
							<div className='overflow-hidden bg-black  transition-all duration-500 max-h-0 peer-checked:max-h-60'>
								<div className='p-5'>
									<p className='lg:px-10 px-5 '>
										A conversation that initiates from a business sending a user
										a message outside the 24-hour customer service window.
										Messages that initiate a business-initiated conversation
										will require a template.
									</p>
								</div>
							</div>
						</div>
				...
				<div className=' relative md:w-1/2 md:mx-auto w-auto overflow-hidden'>
					<input
						type='checkbox'
						className='absolute top-0 inset-x-0 w-full sm:h-16  h-20 opacity-0 z-10  cursor-pointer peer'
					/>
					...
					<div className='overflow-hidden bg-black  transition-all duration-500 max-h-0 peer-checked:max-h-60'>
						<div className='p-5'>
							<p className='lg:px-10 px-5 '>
								No, you can’t! The number which is active on WhatsApp Business
								API can’t be registered on WhatsApp Apps.
							</p>
						</div>
					</div>
				</div>
