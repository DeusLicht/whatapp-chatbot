						...
						<form className='flex flex-col px-5 gap-5'>
							<div className='flex gap-x-3'>
								<div className='flex flex-col'>
									...
									<input
										className='h-12 max-w-[200px] rounded-md text-black px-3 focus:outline-none'
										placeholder='Jeff'
									/>
								</div>
								<div className='flex flex-col'>
							...
							<div className='flex flex-col'>
								...
								<input
									className='h-12 rounded-md text-black px-3 focus:outline-none'
									placeholder='jeff@jeffinc.com'
								/>
							</div>
							<div className='flex flex-col'>
								<label className='font-bowl text-black text-xl py-1'>
								...
								<textarea
									className='h-28 rounded-md text-black text-start px-3 py-3 focus:outline-none'
									placeholder='Message'
								/>
							</div>
							<input
								type='submit'
								value='Send'
								className='h-12 w-32 rounded-md cursor-pointer bg-black hover:bg-white hover:text-[#0071FF] duration-200'
							/>
						</form>
					</div>
					<div className='w-[600px] flex flex-col gap-3 ml-3'>
						<h4 className='text-lg text-[#0071FF]'>Our Contact</h4>
						...
						<p className='leading-snug text-[#7a7a7a] '>
							We are one of the leading chatbot solution provider in the UAE
							helping businesses to function smartly and efficiently and boost
							their sales.
						</p>
						<div className='grid grid-cols-2 gap-x-2 gap-y-5 pt-5'>
							...
							<div className='flex flex-col px-3 '>
								<h3 className='font-bowl text-2xl leading-snug'>Follow Us</h3>
				...
				<div className='mx-auto flex flex-col gap-14'>
					<div className='max-w-[900px] flex flex-col items-center self-center gap-3'>
						...
						<div className='flex sm:gap-20'>
							...
							<div className='flex flex-col gap-[42px] px-1'>
								<div className='flex mr-auto'>
									<div className=' mt-0.5'>
										<svg
											xmlns='http://www.w3.org/2000/svg'
