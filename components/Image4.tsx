			...
			<motion.div
				...
				<motion.div
					...
					<Image
						src={shuttle}
						alt='/'
						className=' object-cover md:h-[720px] md:object-bottom md:ml-20 md:mb-4 lg:mb-0 lg:ml-0 rounded-xl xl:scale-100 md:scale-125'
						priority
					/>
					...
					{isLarge ? (
						<div className='absolute top-[20%] right-[10%] lg:w-[35%] md:w-[45%]'>
							...
							<p className='text-xl leading-snug xl:text-2xl text-shadow-sm shadow-black'>
								Improve customer satisfaction by automating customer servicing,
								appointment bookings, reservations and account management.
							</p>
						</div>
					) : (
						<div className='mt-5'>
